...
export default function MyAds() {
  ...
  // Special message for moderators
  if (user.userType === "moderator") {
    return (
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 mb-6">My Ads</h1>

          <div className="bg-white shadow rounded-lg p-6 text-center">
            <h2 className="text-xl font-semibold mb-4">Moderator Account</h2>
            <p className="mb-4">
              As a moderator, you cannot create or manage personal ads. This restriction is in place to maintain the
              integrity of the moderation process.
            </p>
            <p className="text-gray-600">
              You can access the moderation panel to review and approve ads submitted by users.
            </p>
